...
`validation/validate_triangular_matched_asr.py --integration --order 3 --grid 192` のbaseline結果は
...
詳細は `design_gradient_report_ja.md` と `validation/validate_design_gradients.py` を参照すること。
